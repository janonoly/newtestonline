...
class question(models.Model):
    ...
    questionType = models.CharField(max_length=20, choices=(("xz", u"单选题"), ("pd", u"判断题"), ("mxz", u"多选题"), ("jd", u"简答题")), default="xz", verbose_name=u"题目类型")
...
class PaperList(models.Model):#用于查看往期考试题目可能不用
    ...
    jd_choice_num = models.IntegerField(verbose_name=u"简答题数", default=0)
    jd_choice_score = models.IntegerField(verbose_name=u"简答分值", default=0)
